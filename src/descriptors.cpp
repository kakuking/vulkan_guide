...
class Descriptors{
    public:
        ...
        void setupUniformBuffersDescriptorPoolsAndSets(VkDevice device, VkPhysicalDevice physicalDevice, VkImageView textureImageView, VkSampler textureSampler){
            createUniformBuffers(device, physicalDevice);
            createDescriptorPool(device);
            createDescriptorSets(device, textureImageView, textureSampler);
        }
        ...
        void createDescriptorSets(VkDevice device, VkImageView textureImageView, VkSampler textureSampler){
